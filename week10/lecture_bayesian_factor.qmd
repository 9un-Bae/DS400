...
```{r}
weekend_rides <- subset(bikes, weekend == TRUE)$rides
non_weekend_rides <- subset(bikes, weekend == FALSE)$rides

mean_weekend_rides <- mean(weekend_rides, na.rm = TRUE)
mean_non_weekend_rides <- mean(non_weekend_rides, na.rm = TRUE)

cat("Mean rides on weekends:", mean_weekend_rides, "\n")
cat("Mean rides on non-weekend days:", mean_non_weekend_rides)
```
...
-   mean_consumeAhi \<- mean(consumesAhi, na.rm = TRUE)

    mean_noAhi \<- mean(noAhi, na.rm = TRUE)

    cat("Mean consumes ahi:", mean_consumesAhi, "\\n")

    cat("Mean no ahi:", mean_noAhi)
